...
mod tests {
    ...
    impl Handler<Bytes> for ErrorHandler {
        ...
        fn handle(&self, _request: http::Request<Bytes>) -> Result<http::Response<Bytes>, Self::Error> {
    ...
    impl Handler<Vec<u8>> for GenericEchoHandler {
        ...
        fn handle(&self, request: http::Request<Vec<u8>>) -> Result<http::Response<Vec<u8>>, Self::Error> {
            http::Response::builder()
                .status(200)
                .body(request.into_body())
        }
